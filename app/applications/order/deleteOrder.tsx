...
const DeleteOrder = (params: Order) => {
    ...
    const handleSubmit = async (e: SyntheticEvent) => {
        ...
        try {
            const res = await axios.delete(`${process.env.NEXT_PUBLIC_API_URL}/orders/${params.id}`);
        ...
        <div>
            ...
            <div className="modal">
                <div className="modal-box">
                    <h3 className="font-bold text-lg mb-5">Hapus Pemesanan dengan nama {params.order_name}?</h3>
