...
const AddProduct = () => {
    ...
    const handleSubmit = async (e: SyntheticEvent) => {
        ...
        try {
            const res = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/entrusted-products`, data);
    ...
    return (
        <div>
            <button className="btn btn-neutral capitalize btn-sm mb-5" onClick={handleModal}>Tambah Kategori</button>
