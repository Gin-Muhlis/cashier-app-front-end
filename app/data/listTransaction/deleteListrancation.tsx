...
const DeleteTransaction = (params: Transaction) => {
    ...
    const handleSubmit = async (e: SyntheticEvent) => {
        ...
        try {
            const res = await axios.delete(`${process.env.NEXT_PUBLIC_API_URL}/transactions/${params.id}`);
            ...
            setMessage('Transaksi gagal dihapus')
            router.refresh();
        }
        ...
        <div>
            ...
            <div className="modal">
                <div className="modal-box">
                    <h3 className="font-bold text-lg mb-5">Hapus Transaksi dengan nominal {params.total_payment}?</h3>
