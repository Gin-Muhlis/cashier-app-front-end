...
const importData = async (formData: FormData) => {
    try {
        ...
        const response = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/import-products`, formData, {
            headers: {
...
const ImportProduct = () => {
    ...
    return (
        <div>
            <button className="btn capitalize btn-success btn-sm mb-5" onClick={handleModal}>
