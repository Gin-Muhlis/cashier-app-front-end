...
const DeleteDetailTransaction = (params: DetailTransaction) => {
    ...
    const handleSubmit = async (e: SyntheticEvent) => {
        ...
        try {
            const res = await axios.delete(`${process.env.NEXT_PUBLIC_API_URL}/transaction-details/${params.id}`);
            ...
            setMessage('Detail Transaksi gagal dihapus')
            router.refresh();
        }
        ...
        <div>
            ...
            <div className="modal">
                <div className="modal-box">
                    <h3 className="font-bold text-lg mb-5">Hapus Detail Transaksi dengan sub total {params.sub_total}?</h3>
...
export default DeleteDetailTransaction;